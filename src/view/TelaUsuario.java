...
//        String lista = controllerUsuario.listar();
    ...
    public void tabela() throws Exception{
     ...
     //   DefaultTableModel modeloTable = (DefaultTableModel) tblUsuario.getModel();  
        
      //  modeloTable.addColumn(user.getNome());
       // modeloTable.addColumn(user.getLogin());
...
txtConfSenha.setText(null);        // TODO add your handling code here:
    ...
    private void tblUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuarioMouseClicked
        ...
        int id = Integer.parseInt(tblUsuario.getValueAt(row, 0).toString());
        System.out.print(tblUsuario.getValueAt(row, 0).toString());
        ControllerUsuario controllerUsuario = new ControllerUsuario();
        Usuario u = new Usuario();
        try {
           u =  controllerUsuario.dadosId(id);
           txtId.setText(""+u.getId());
           txtNome.setText(u.getNome());
           txtLogin.setText(u.getLogin());
           txtSenha.setText(u.getSenha());
           txtConfSenha.setText(u.getSenha());
