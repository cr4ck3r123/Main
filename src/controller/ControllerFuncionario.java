...
public class ControllerFuncionario {
			...
			String msg = "deu";
			String chamada = "http://localhost:8090/WebService/rest/funcionario/adicionar";
   ...
   //METODO PEGAR ID FUNCIONARIO
                public String retornoid() throws Exception{
                    ...
                    String chamada = "http://localhost:8090/WebService/rest/funcionario/id/";
		    HttpExemplo http = new HttpExemplo();
   ...
   // METODO LISTAR
    public  void listarFuncionario() throws Exception{
			...
			Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
                        ...
                        java.lang.reflect.Type usuarioType = new TypeToken<List<Funcionario>>() {}.getType();
