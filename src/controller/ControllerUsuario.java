...
public class ControllerUsuario {
		...
		public int logar(Usuario dados) throws Exception {			
			...
			String chamada = "http://localhost:8080/WebService/rest/usuario/autenticar/"+login+"/"+senha;
		...
		return i;
               ...
               //METODO LISTAR
                public  void listarUsuario() throws Exception{
                        ...
                        HttpExemplo http = new HttpExemplo();
			String chamada = "http://localhost:8080/WebService/rest/usuario/listarUsuario";
			String json = http.sendGet(chamada);
			Gson gson = new Gson();
                ...
                public Usuario dadosId(int id) throws Exception{
                    ...
                    String chamada = "http://localhost:8080/WebService/rest/usuario/pesquisar/"+id+"";
                    HttpExemplo http = new HttpExemplo();
                    String json = http.sendGet(chamada);
                    Gson gson = new Gson();
                ...
                public void deletarUsuario(int id) throws Exception{
                    String chamada = "http://localhost:8080/WebService/rest/usuario/delete/"+id+"";
                    HttpExemplo http = new HttpExemplo();
                ...
                public String retornoid() throws Exception{
                    ...
                    String chamada = "http://localhost:8080/WebService/rest/usuario/idUsuario/";
		    HttpExemplo http = new HttpExemplo();
                    String json = http.sendGet(chamada);
		...
		public String inserir(Usuario dados) throws Exception {
			...
			String msg = "deu";
			String chamada = "http://localhost:8080/WebService/rest/usuario/adicionar";
			HttpExemplo http = new HttpExemplo();
			Gson gson = new Gson();
	   ...
	   /*
	      ...
	      http.sendPost(url, json, "PUT");
			*/
			...
			String msg = "deu";
			String chamada = "http://localhost:8080/WebService/rest/usuario/update/";
			HttpExemplo http = new HttpExemplo();
			Gson gson = new Gson();
